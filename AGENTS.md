...
## Repository map
- `Agents_design-v2/` — explain what lives here and when agents should edit it.
- `Agents_design-v3/` — explain what lives here and when agents should edit it.
- `eslint.config.js/` — explain what lives here and when agents should edit it.
- `exemplo do gpt/` — explain what lives here and when agents should edit it.
- `extrair_itens_docx.py/` — explain what lives here and when agents should edit it.
